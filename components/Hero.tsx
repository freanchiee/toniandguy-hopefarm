          ...
          <div>
            <div className="flex flex-col items-start gap-2.5">
              <div className="flex items-center gap-3">
                {/* TG logo in dark pill so grey brand bg is contained */}
                <div className="relative h-[80px] w-[57px] shrink-0 overflow-hidden rounded-xl bg-[#3a3a3a] shadow-lg md:h-[96px] md:w-[68px]">
                  <Image
