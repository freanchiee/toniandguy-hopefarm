...
export const metadata: Metadata = {
  ...
  description:
    "Professional keratin treatment, Nanoplastia & protein smoothening at Toni & Guy Hopefarm, Whitefield Bangalore. Prices from ₹1,800. Frizz-free, silky smooth hair for 3–6 months. Book online for up to 35% off.",
  keywords: [
    "keratin treatment whitefield", "keratin treatment bangalore", "keratin treatment hopefarm",
    "nanoplastia whitefield", "hair smoothening whitefield bangalore", "protein smoothening bangalore",
  ...
  openGraph: {
    ...
    description: "Keratin, Nanoplastia & protein smoothening from ₹1,800. 3–6 months frizz-free results. Toni & Guy Hopefarm, Whitefield Bangalore.",
...
const schema = {
  ...
  alternateName: ["Nanoplastia", "Protein Smoothening", "Hair Smoothening Treatment"],
  description: "Professional keratin hair smoothening treatments at Toni & Guy Hopefarm Whitefield. Includes Brazilian keratin, Nanoplastia, and protein smoothening. Results last 3–6 months.",
  provider: {
    "@type": "HairSalon",
  ...
  offers: [
    ...
    { "@type": "Offer", name: "Protein Smoothening Treatment", price: "2800", priceCurrency: "INR" },
  ],
};
    ...
    <main className="min-h-screen bg-salon-black px-5 pb-24 pt-28 text-white md:px-8 md:pt-36">
      ...
      <div className="mx-auto max-w-3xl">
        ...
        <p className="mt-6 text-lg leading-relaxed text-white/70">
          Professional keratin smoothening, Nanoplastia, and protein smoothening at Toni &amp; Guy Hopefarm, Whitefield.
        ...
        <section className="mt-14">
          ...
          <div className="mt-6 divide-y divide-white/8 rounded-2xl border border-white/8 overflow-hidden">
            {[
              ...
              { name: "Protein Smoothening Treatment", price: "₹2,800+" },
            ].map((item) => (
        ...
        <section className="mt-14">
          ...
          <ul className="mt-4 space-y-3">
            {[
              ...
              { name: "Protein Smoothening", desc: "Deep conditioning treatment that fills in hair porosity. No harsh chemicals — great for colour-treated hair." },
            ].map((t) => (
